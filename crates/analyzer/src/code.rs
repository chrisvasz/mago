...
impl IssueCode {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::DeprecatedClassConstant => "deprecated-class-constant",
...
impl std::str::FromStr for IssueCode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "deprecated-class-constant" => Ok(Self::DeprecatedClassConstant),
            ...
            "deprecated-property" => Ok(Self::DeprecatedProperty),
