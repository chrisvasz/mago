...
test_case!(missing_template_parameter_in_type_hints, crate::framework::check_missing_type_hints_settings());
test_case!(missing_template_parameter_in_type_hints_satisfied, crate::framework::check_missing_type_hints_settings());
test_case!(missing_template_parameter_inheritance_once, crate::framework::check_missing_type_hints_settings());
